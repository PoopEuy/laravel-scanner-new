        ...
        <div id="frame1_simbol">
            <div class="row" style="display: block">
                <div class="form-group col-md-12">
                    ...
                    <h5 class="display-6" style="text-align: center;">Talis 5</h5>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function searchFrame(frame_qr_code) {
                $.ajax({
                    type: "get",
                    url: "{{ url('getFramesBySN') }}/" + frame_qr_code,
                    // data: "name=" + name,
            ...
            $('body').on('click', '#save_frame', function() {
                ...
                //create frame list on t_frame table
                $.ajax({
                    type: "post",
                    url: "{{ url('createFrame') }}",
                    data: {
                    ...
                    success: function(res) {
                        console.log(res)
                        resTFrameStatus = res.status;
                        console.log("resTFrameStatus : " + resTFrameStatus)
                        tframeStatus(resTFrameStatus);
            ...
            function tframeStatus(resTFrameStatus) {
                console.log("tframe status cehck")
                if (resTFrameStatus == 'success') {
                    ...
                    var message = "Failed Update Frame List, Please Contact Admin";
